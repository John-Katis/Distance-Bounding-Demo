...
def ski_mf(ver_host=HOST, ver_port=VERIFIER_PORT, atk_listen_port=ATTACKER_PORT):
    st = load_json(f"{STATE_DIR}/ski_prover_state.json")
    n = st["n"]
    a1, a2 = st["a1"], st["a2"]
...
if __name__ == "__main__":
    ...
    ap.add_argument("mode", choices=["df", "mf", "tf"])
    ...
    if args.mode == "df":
        ...
        ski_mf(ver_port=args.ver_port, atk_listen_port=args.mf_listen)
    else:
